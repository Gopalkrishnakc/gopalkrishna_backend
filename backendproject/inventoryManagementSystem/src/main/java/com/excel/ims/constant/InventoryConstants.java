package com.excel.ims.constant;

public class InventoryConstants {
	
	private InventoryConstants() {}
	public static final String ITEM_NOT_FOUND=" Item not Found";
	public static final String USER_ALREDY_FOUND=" User already Found";
	public static final String NO_USER_FOUND="  No User Found";
	public static final String NO_EMAIL_FOUND=" No Email Found";
	public static final String NO_ORDERS_FOUND=" No Odrer Found";
